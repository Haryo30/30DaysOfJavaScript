// match: it takes a substring or regular expression pattern as an argument and it returns an array if there is match if not it returns null. Let us see how a reguler expression pattern looks like. It starts with / sign and ends with / sign.
